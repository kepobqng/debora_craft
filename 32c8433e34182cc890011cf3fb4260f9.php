<?php $__env->startSection('navigation'); ?>
    ...
    <a href="<?php echo e(route('user.profile')); ?>" class="inline-flex items-center px-1 pt-1 text-sm font-medium text-gray-500 hover:text-gray-700 border-b-2 border-transparent hover:border-gray-300">
        Profile
    </a>
    <a href="<?php echo e(route('user.settings')); ?>" class="inline-flex items-center px-1 pt-1 text-sm font-medium text-black border-b-2 border-black">
        Settings
    </a>
                ...
                <div>
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="email" id="email" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-black focus:border-black" value="<?php echo e(Auth::user()->email ?? 'user@example.com'); ?>">
                        </div>
                        <div>
                            <label for="name" class="block text-sm font-medium text-gray-700">Display Name</label>
                            <input type="text" id="name" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-black focus:border-black" value="<?php echo e(Auth::user()->name ?? 'User Name'); ?>">
                        </div>
                    </div>
                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('dashboard.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Debora_Craft\resources\views\dashboard\user\settings.blade.php ENDPATH**/ ?>