<?php $__env->startSection('title', 'Dashboard - Debora Craft'); ?>
        ...
        <div class="w-full lg:w-3/5 flex items-center px-8 lg:px-16 py-16 lg:py-24">
            <div class="max-w-2xl">
                ...
                <div class="flex flex-col sm:flex-row gap-4">
                    <a href="<?php echo e(route('kategori')); ?>" class="bg-pink-500 text-white px-8 py-4 rounded-lg font-semibold hover:bg-pink-600 transition duration-300 text-center">
                        Explore Bouquet
                    </a>
                    <a href="<?php echo e(route('cart')); ?>" class="bg-transparent border-2 border-pink-500 text-pink-600 px-8 py-4 rounded-lg font-semibold hover:bg-pink-50 transition duration-300 text-center">
                        Lihat Keranjang
                    </a>
                </div>
            </div>
        ...
        <div class="hidden lg:flex lg:w-2/5 items-center justify-center p-8 lg:p-16">
            <div class="w-full max-w-md">
                <div class="rounded-2xl shadow-xl overflow-hidden">
                    <img src="<?php echo e(asset('img/Beautiful Flower Bouquet.png')); ?>" 
                ...
                <?php if(isset($products) && count($products) > 0): ?>
                    ...
                    <div class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition duration-300">
                        ...
                        <div class="p-6">
                            ...
                            <p class="text-gray-600 mb-4"><?php echo e(Str::limit($product->description ?? 'Produk bunga berkualitas tinggi', 80)); ?></p>
                            ...
                            <div class="flex gap-3">
                                <a href="<?php echo e(route('product.detail', $product->id)); ?>" class="flex-1 text-center text-pink-600 font-medium hover:text-pink-700 border border-pink-600 px-4 py-2 rounded-lg hover:bg-pink-50 transition">
                                    Detail
                                </a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Debora_Craft\resources\views/dashboard/user/index.blade.php ENDPATH**/ ?>